...
CDigitalBeamFormer::DBFprocessorCP(EMSTIME tm )
{
	...
	if (m_asRawTimeSeries )
	{
		...
		i = 0;
		printf("CP %d, Power %6.2f, Sat %d (%d), Az %6.2f (%6.1f), El %5.2f (%5.2f), Time %f, Id: %i \n",
...
CDigitalBeamFormer::_OutputWaveEx( EMSTIME tm, ULONG culNumSats, bool bBandwidthFlag  )
{
	...
	for( int iSat = 0; iSat < culNumSats; iSat++ )
	{
		...
		{
			if ( ulSatID == m_iPredictedSATIDs[jsat] )
			{
...
CDigitalBeamFormer::DBFCarrierTrack( EMSTIME tm, ULONG *m_ulFreqIndex, float *m_fMaxpower )
{
	...
	for ÍÄ Ä•w  ‚x  úz  Ëw  tÑ  ux  —Ç  <|  `x  
Å  s|  Î|  y  Ïx  YÅ  6r  m{  /{  ôy  ˘v  9y  Q}  ¢}  qÉ  Cy  hz  ï{  Vw  ˘~  §z  £u  ÒÄ Äy  ¯|  ”{  t  é{  \x  ﬁs  y  %}  4  Dv  ˆv  ”z  >~  ïu  ≤|  fu  "t  Ä  }v  µw  ﬁx  Õv  úu  Ïz  Yy  &|  ‡}  +{  ]{  {y  ÙÄ Ä0  …z  z  ÷Å  Do  n~   w  Ï|  l}  Et  Bw  …{   ~  ´{  æs  ¥}  ˘v  JÄ  h{  ä|  ¥Å  ≥y  4{  y  |w  ºy  jv  ¢z  ´t  <z  Ù  ÛÄ Ä3}  Êz  Ñ  q|  mÇ  tz  ~  ó|  ±|  πy  ßÑ  ƒ{  …y  zx  üÅ  ∞{  v}  ,~  ¥v  ıv  x  [  ﬁ{  A~  Ë~  }  Òy  –{  -Å  ÖÄ  pz  ËÄ Äv  «{  Ãx  v  j{  Yz  T|  <y  @v  ∫  Öw  Àx  x  6~  ˙z  0u  y  u  ø  —y  bz  mw  ¸x  I}  c  *{  Vw  Åy  6{  ãx  ê{  ÂÄ Äîy  Áw  ~w  /}  ±y  ‹}  /}  ôy  ºy  fy  %y  Q|  =  œv  Êu  äx  Ωx  ã|  G|   z  √z  ãz  ¶x  <u  Fx  ?z  ;}  {  Hy  ax  íz  ÛÄ Ä/  `{  }Ä  ¸w  Óx  ïv  Ÿw  R}  ºÄ  kw  ª|  ‹|  z  Ñz  y  ‚~  |x  Å  ®w  mv  ñz  Y}  À~  Ä  ﬁq  H}  x  \|  /z  ‡{  ‰v  ıÄ ÄÓy  ç}  é{  Ñ  !{  ß{  >x  µ|  —y  +|  ez  Ày  ∂v  ¬Å  ∞z  ·x  ôx  ïw  ®}  !y  ,}  ix  Cy  @|  5Ö  Ûx  av  Ëx  B|  Ò~  gÄ  ÒÄ Äyy  ow  ”y  º{  µ{  œ}  ∏}  4z  Cy  1Ä  Û}  	y  ∆  Ås  O|  ˛x  '{  |  ÷z  6{  ßy  {  Ûw  áv  -}  Øx  S{  ù~  G|  2|  wx  ÁÄ Äüz  ç{  ï{  +x  õy  {  v~  ·z  —z  z  fy  v{  åx  Xy  ˘w  xw  w  Ü|  nz  Vy  s|  Ü|  ˙y  (|  Éq
  ú|  %}  |    z  êz  L}  .{  qq  W}  q|  “{  J}  Ax  ∂}  ¨w  ÿy  †z  ås  †|  }  òv  Í  Kz  ˙|  √}  ~{  v|  ~  {z  ÈÄ Ä3w  a~  Òz  ur  ~v  Êw  x  ñz  ˝x  {  `{  =u    _z  Ev  ß|  x  e|  cy  ˛y  Éw  6x  |  u  Ëz  ˚x  Äz  )}  Æv  πw  …  ÍÄ Ä[y  (t  Öz   }  ˇw  ﬁ{  ´  ı~  }  …~  $|  ®|  Wu  [t  n|  êv  E{  ß|  T{  ˝x  .  
z  †y  ¨|  3  ax  ôw  »w    áz  x  ÙÄ Ä–y  a}  ,}  µ~  S|  {  »u  ˙w  l|  ÿy  Ëz  9z  ¿}  ﬂ  Ez  cy  xx  Øu  h{  †w  áz  ™}  0{  s~  lw  ﬂ~  Çz  ÙÄ  'y  AÄ  çw  ıÄ Ä7~  º}  m|  8z  <  ®~  Ûv  mx  `w   z  ûw  ì}  r|  R}  ∫z  ˝z  Mx  |}  ˝~  b}  ew  1z  ì|  ~u  £{  Ω|  x  °x  ê~  3y  ’~  Ä Ä≈z  ±x  æu  "{  0u  Éx  Y}  I  Ω}  Ñv  (~  ‘{  ©v  æv  ›x  ºz  ‘x  Q}  0z  ßt  3Å  >x  Ãt  ∞Ä  ey  @x  å|  ˙w  ›x  ”}  ]x  ÓÄ Ä€x  ©{  ¶Ä  Ωx  ªy  ;w  Í  |  ∂|  ’Å  Ïz  Ùt  Û}  æz  Ωv  K{  ∑y  `|  —x  y  ày  °{  d}  Ey  ß}  ©x  lu  qx  Ây  ßy  Åz  ÏÄ Ä°{  ¶v  B|  ~  ‚Ä  3Å  Ow  êx  [z  ?x  ˘z  |  À{  ì~  Ò~  ≈x  ¨z  .y  ;{  ˛y  kw  ì|  a{  Lz  y  Î|  *{  ö  8}  »y  ¶~  ÏÄ ÄIz  n|  “s  y  Ùw  y  Mx  {  -y  -w  á}  ƒ  ™w  Py  íu  =w  πx  Ey  p}  §x  Az   {  ¨z  ñ|  }  ˚|  œx  “Ä  #y  @{  Xz  ÏÄ Ä'|  ~~  ˆÅ  {  Oy  ìv  á  {  ≤z  LÄ  œv  ·|  z  ﬂz  Îy  w{  àu  Å  Ö~  L}  m  ˜x  tw  ˚w  ´{  Óy  Çv  Xs  ÇÄ  æ~  #t  ÒÄ Ä1{  ê~  ç}  ﬂz  ªz  nÑ  y  ë}  P|  ¢v  È~  ,u  ’x  My  ~}  f~  ∏|  ‹s  x  és  ÿy  ty  á}  ﬂ  Ây  æz  Ï~  gx  ay  «z  I  ÁÄ Äıx  ôq  4t  ‰x  Çz  ≤t  úy  ±z  ¯}  ?|  vw  ku  ©w  %y  Zv  Pw  Ày  |  x   y  l{  ú|  ◊u  ∫w  v{  {  ty   Ç  t  ≈v  =  ÏÄ Äß}  Dz  0~  +Ä  9z  ^w  ˚~  ∞x  yy  .~  ˇ~  VÖ  ¢  ñ  {  ⁄w  åv  ÇÇ  }  æy  Œz  ö{  RÄ  
|  ƒu  ¥y   u  v  bÉ  ı}  /x  Ä Äyz  ⁄Ä  T}  'x  SÄ  ≤Å  0x  %~  jx  ay  ·{  cx  Iz  )z  ö{  à{  Xy  ∆v  -~  ]z   z  µy  ˚t  ê}  z  Ú{  ˇw  ¶|  ˚|  ë~  Ax  ÒÄ ÄLw  ùz  d{  y  Uw  øv  É{  Qw  '~  w  är  vv  Ø|  Ìw  ÷v  ˜z  y  -}  *|  ºx  Íy  ly  -~  ›y  ø{  Ë{  Ô  c}  nt  8x  Y{  ÍÄ Äˆ{  ïx  Ûv  |  øt  ú~  y  k~  t|  ∂{  É  ñÄ  Œv  {  ¥v  Éz  êz  ∏x  Py  ©w  r}   |  ày  ·z  ∑x  }z  ex  
u  ~  Íy  ¯|   m_acTemp3, &m_acMatrix[ielem*DBF_LOG19_SIZE], DBF_LOG19_SIZE * sizeof(EMSCOMPLEX));
	...
	if( lpBiasFile != NULL )
	{
		for (int isat = 0; isat < m_ulSatellites; isat++ )
		{
			...
			for ( int i = 0; i < DBF_NUM_ELEMENTS; i++ )
			{
				...
				cTemp.re = m_acTemp2[i].re;
				cTemp.im = m_acTemp2[i].im;
				fAmplitude = sqrt( cTemp.re*cTemp.re + cTemp.im*cTemp.im );
				m_acTemp2[i].re /= fAmplitude;
				m_acTemp2[i].im /= fAmplitude;
			}
			...
			for ( int i = 0; i < DBF_NUM_ELEMENTS; i++ )
			{
				...
				cTemp.re = cos(m_aPassSchedule.rec[isat].fPhase[i+1]);
				cTemp.im = sin(m_aPassSchedule.rec[isat].fPhase[i+1]);
			...
			fwrite( &m_acTemp1[0],  nBytes, 1, lpBiasFile );
			ulIndex = ftell(lpBiasFile);
...
CDigitalBeamFormer::TestDBFprocessor( int nProcess )
{
	...
	sprintf(szFileDirectory,"D:\\HGT\\RawDataBin\\Galileo_2sec\\");
	...
	for ( int ifile = 0; ifile < 9; ifile++ )
	{
		...
		sprintf(szFileName, "C:\\HGT\\DBFPassData\\BIN\\EMSDBFPass-%d.bin", tmFields.nHour );
...
CDigitalBeamFormer::SatelliteIdentify( ULONG m_ulSatellites  )
{
	...
	sprintf(szFileName,"C:\\HGT\\DBFPassData\\SatID\\DBF_SatID_%06d.bin", ulHourSec);
...
CDigitalBeamFormer::SatelliteTOAFOA(  int isat )
{
	...
	float fCNR = 0.0;
	float fCNRthreshold  = 30.0; // temporary
	float fCORRthreshold = 20.0;
	...
	if ( fCNR > fCNRthreshold )
	{
		...
		//CopyData( &fTestBeacon[0], 2.0, 19 );
		//CopyData( &fTestBeacon[20], 1.0, 43 );
		//fAvePower = _EMSsMean(&fTestBeacon[0], 128 );
		//emssbSub1( fAvePower, &fTestBeacon[0], 128 );

		CopyData( &fTestBeacon[0], 2.0, 20*8 );
		CopyData( &fTestBeacon[160], 1.0, 44*8 );
		...
		m_aTOAFOA.fTOA[isat]	 = (float)ulTimeIndex / 1024;
...
EMS_RESULT
CDigitalBeamFormer::CopyData(  float* fTest, float fValue, ULONG nCount )
{
	EMS_RESULT hr = EMS_OK;
