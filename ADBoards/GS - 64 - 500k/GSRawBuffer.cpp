...
//	memset(&m_PassRecords, 0, sizeof(EMSDBFPASSRECORDS) );
}
...
void 
CEMSRawBuffObj::SetPassRecs( EMSDBFPASSRECORDS& passRecs )
{
	memcpy( &m_PassRecords, &passRecs, sizeof(EMSDBFPASSRECORDS) );
}