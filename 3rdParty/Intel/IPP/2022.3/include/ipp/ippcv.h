...
extern "C" {
    ...
    #pragma comment( lib, __FILE__ "/../../../lib/ippcv" )
    #pragma comment( lib, __FILE__ "/../../../lib/ippcore" )
  #elif defined( _IPP_SEQUENTIAL_STATIC )
    #pragma comment( lib, __FILE__ "/../../../lib/ippcvmt" )
    #pragma comment( lib, __FILE__ "/../../../lib/ippimt" )
    ...
    #pragma comment( lib, __FILE__ "/../../../lib/threaded/ippcv" )
    #pragma comment( lib, __FILE__ "/../../../lib/threaded/ippcore" )
  #elif defined( _IPP_PARALLEL_STATIC )
    #pragma comment( lib, __FILE__ "/../../../lib/threaded/ippcvmt" )
    #pragma comment( lib, __FILE__ "/../../../lib/threaded/ippimt" )
