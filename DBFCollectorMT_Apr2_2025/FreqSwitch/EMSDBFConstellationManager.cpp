...
//std::string inputXmlFile = "C:\\Users\\joshua.rehm\\DBFCollectorMT_03_26_26\\Config\\DBFConstellation.xml";
static const std::string& inputXmlFile = CDBFCollectorConfig::GetInstance().GetConstellationFile();
