...
#define DBF_ELEMENTS		(32)		// number of antenna elements (assume 1 channel is reserved for 1 pPS signal)
...
typedef struct _tagEMSDBFCALIBRECORD
{
	...
	short fCalibPhaseReal[DBF_ELEMENTS];	// Measured Phase correction real components (up to DBF_MAX_CHANNELS channels)
	short fCalibPhaseImag[DBF_ELEMENTS];	// Measured Phase correction imaginary components (up to DBF_MAX_CHANNELS channels)
