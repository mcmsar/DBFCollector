...
#pragma comment( lib, __FILE__ "/../../../lib/ipps" )
#pragma comment( lib, __FILE__ "/../../../lib/ippcore" )
#elif defined( _IPP_SEQUENTIAL_STATIC )
#pragma comment( lib, __FILE__ "/../../../lib/ippsmt" )
#pragma comment( lib, __FILE__ "/../../../lib/ippvmmt" )
#pragma comment( lib, __FILE__ "/../../../lib/ippcoremt" )
#elif defined( _IPP_PARALLEL_DYNAMIC )
#pragma comment( lib, __FILE__ "/../../../lib/threaded/ipps" )
#pragma comment( lib, __FILE__ "/../../../lib/threaded/ippcore" )
#elif defined( _IPP_PARALLEL_STATIC )
#pragma comment( lib, __FILE__ "/../../../lib/threaded/ippsmt" )
#pragma comment( lib, __FILE__ "/../../../lib/threaded/ippvmmt" )
...
IPPAPI(IppStatus, ippsAddProductC_32fc, (const Ipp32fc* pSrc, const Ipp32fc val, Ipp32fc* pSrcDst, int len))
IPPAPI(IppStatus, ippsAddProductC_64fc, (const Ipp64fc* pSrc, const Ipp64fc val, Ipp64fc* pSrcDst, int len))
...
//        1728, 1800, 1920, 1944, 2160, 2304, 2400, 2592, 2700, 2880, 2916, 3000, 3072, 3240     - DFT
