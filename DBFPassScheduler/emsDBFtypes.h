...
typedef struct _tagEMSDBFCOVARIANCE
{
	...
	//float   fCovariance[2080];	// Sample matrix components (upper triangular format assuming 64 channels maximum)
	float   fCovariance[DBF_MAX_CHANNELS * DBF_MAX_CHANNELS/2];	// Sample matrix components (upper triangular format assuming N channels maximum)
